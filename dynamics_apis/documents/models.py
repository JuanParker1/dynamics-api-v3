...
class Document(PaginatedModel):
    ...
    def create(
        ...
        ds = KairnialDocumentService(client_id=client_id, token=token, user_id=user_id,
                                     project_id=project_id)
        document_id, name, something = ds.create(document_create_serializer=serialized_data,
